...
//         AIV_WITH_BARRIER(And, mbl_inLocal, mbl_inLocal, mask15Local, tileNum * 2);
        ...
        // AIV_WITH_BARRIER(ShiftRight, (ms_inLocal.template ReinterpretCast<uint16_t>())[computeNum / 2], ms_inLocal.template ReinterpretCast<uint16_t>(), (uint16_t)8, computeNum / 2);
        // AIV_WITH_BARRIER(ShiftLeft, ms_inLocal.template ReinterpretCast<uint16_t>(), ms_inLocal.template ReinterpretCast<uint16_t>(), (uint16_t)8, computeNum / 2);
        // AIV_WITH_BARRIER(ShiftRight, ms_inLocal.template ReinterpretCast<uint16_t>(), ms_inLocal.template ReinterpretCast<uint16_t>(), (uint16_t)8, computeNum / 2);
        ...
        // AIV_WITH_BARRIER(Or, outLocal.template ReinterpretCast<uint16_t>(), outLocal.template ReinterpretCast<uint16_t>(), ms_inLocal.template ReinterpretCast<uint16_t>(), computeNum * 2);
