...
private:
                                ...
                                )
    {
        ...
        AIV_WITH_BARRIER(And, cmblLocal, cmblLocal, mask15Local, tileNum * 2);
        // AIV_WITH_BARRIER(ShiftLeft, cmblLocal, cmblLocal, (uint32_t)28, computeNum);
        // AIV_WITH_BARRIER(ShiftRight, cmblLocal, cmblLocal, (uint32_t)28, computeNum);
