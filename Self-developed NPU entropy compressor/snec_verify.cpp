...
public:
    ...
    __aicore__ inline void decompute(int32_t i, LocalTensor<uint8_t> tempLocal){
        ...
        // ReduceXorSum<T, false>(outLocal, decompLocal, srcLocal, tempLocal, dataBlockSize / sizeof(T));
        // for(int i = 0; i < 
        //     dataBlockSize / sizeof(T)
        //     // 1
        //     ; i ++){
        //     outLocal(0) = 0;
        //     if(decompLocal(i) != srcLocal(i)) {outLocal(0) = 1; break;}
        // }
        int num = 0;
...
extern "C" void verify(Header *cphd, void *stream, uint8_t *decompressedDevice, uint8_t* srcDevice, uint8_t* outDevice){
